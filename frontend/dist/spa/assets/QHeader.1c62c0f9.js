...
var L = b({
    ...
    setup(t, { slots: s }) {
      ...
      return () => c("div", { class: n.value }, Q(s.default));
    },
  }),
  R = b({
    name: "QToolbar",
    ...
    setup(t, { slots: s }) {
      ...
      return () => c("div", { class: n.value, role: "toolbar" }, Q(s.default));
    },
  }),
  S = b({
    name: "QHeader",
    ...
    setup(t, { slots: s, emit: n }) {
      ...
      const f = q(parseInt(t.heightHint, 10)),
        ...
        y = o(() => {
          ...
          if (h.value === !0) return u.value === !0 ? f.value : 0;
        ...
        x = o(() => {
          ...
          return (
            e[0] === "l" &&
              a.left.space === !0 &&
              (r[v.lang.rtl === !0 ? "right" : "left"] = `${a.left.size}px`),
            e[2] === "r" &&
              a.right.space === !0 &&
              (r[v.lang.rtl === !0 ? "left" : "right"] = `${a.right.size}px`),
            r
          );
        });
      function l(e, r) {
      ...
      function B(e) {
        V.value === !0 && i(u, !0), n("focusin", e);
      }
      d(
        () => t.modelValue,
        (e) => {
          l("space", e), i(u, !0), a.animate();
        }
      ),
        d(y, (e) => {
          l("offset", e);
        ...
        d(
          () => t.reveal,
          (e) => {
            e === !1 && i(u, t.modelValue);
          }
        ),
        d(u, (e) => {
          a.animate(), n("reveal", e);
        }),
        d(a.scroll, (e) => {
          t.reveal === !0 &&
            i(
