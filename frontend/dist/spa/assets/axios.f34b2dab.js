import { b as ve } from "./index.099d1cbc.js";
var F = { exports: {} },
  re = function (e, t) {
    return function () {
...
var ae = function (e, t, n) {
    ...
    var a;
    if (n) a = n(t);
    else if (g.isURLSearchParams(t)) a = t.toString();
    else {
      var i = [];
      g.forEach(t, function (s, v) {
        s === null ||
          typeof s == "undefined" ||
          (g.isArray(s) ? (v = v + "[]") : (s = [s]),
          g.forEach(s, function (l) {
            g.isDate(l)
              ? (l = l.toISOString())
              : g.isObject(l) && (l = JSON.stringify(l)),
              i.push(z(v) + "=" + z(l));
          }));
      }),
        (a = i.join("&"));
...
`),
          function (u) {
            if (
              ((i = u.indexOf(":")),
              (n = U.trim(u.substr(0, i)).toLowerCase()),
              (a = U.trim(u.substr(i + 1))),
              n)
            ) {
              if (t[n] && Ve.indexOf(n) >= 0) return;
              n === "set-cookie"
                ? (t[n] = (t[n] ? t[n] : []).concat([a]))
                : (t[n] = t[n] ? t[n] + ", " + a : a);
            }
          }
        ),
  ...
  K = function (e) {
    return new Promise(function (n, a) {
      ...
      s.open(e.method.toUpperCase(), Ye(l, e.params, e.paramsSerializer), !0),
        (s.timeout = e.timeout);
      function c() {
        if (!!s) {
          var b =
              "getAllResponseHeaders" in s
                ? Qe(s.getAllResponseHeaders())
                : null,
            y =
              !u || u === "text" || u === "json" ? s.responseText : s.response,
            S = {
              data: y,
              status: s.status,
      ...
      if (
        ...
        var f =
          (e.withCredentials || er(l)) && e.xsrfCookieName
            ? Ge.read(e.xsrfCookieName)
            : void 0;
        f && (o[e.xsrfHeaderName] = f);
      }
      "setRequestHeader" in s &&
        R.forEach(o, function (y, S) {
          typeof i == "undefined" && S.toLowerCase() === "content-type"
            ? delete o[S]
            : s.setRequestHeader(S, y);
        }),
        R.isUndefined(e.withCredentials) ||
          (s.withCredentials = !!e.withCredentials),
        u && u !== "json" && (s.responseType = e.responseType),
  ...
  W = De,
  rr = se,
  tr = { "Content-Type": "application/x-www-form-urlencoded" };
function X(r, e) {
  !d.isUndefined(r) &&
    d.isUndefined(r["Content-Type"]) &&
    (r["Content-Type"] = e);
}
function nr() {
  var r;
...
var P = {
    ...
    function (e, t) {
      return (
        ...
        d.isBlob(e)
          ...
          ? (X(t, "application/x-www-form-urlencoded;charset=utf-8"),
            e.toString())
          : d.isObject(e) || (t && t["Content-Type"] === "application/json")
          ? (X(t, "application/json"), ar(e))
          : e
      );
    },
  ],
  transformResponse: [
    function (e) {
      ...
      if (i || (a && d.isString(e) && e.length))
        try {
          return JSON.parse(e);
        } catch (o) {
          if (i)
            throw o.name === "SyntaxError" ? rr(o, this, "E_JSON_PARSE") : o;
        }
      return e;
    },
  ],
...
var cr = function (e) {
    D(e),
      (e.headers = e.headers || {}),
      (e.data = B.call(e, e.data, e.headers, e.transformRequest)),
      (e.headers = G.merge(
        e.headers.common || {},
        e.headers[e.method] || {},
        e.headers
    ...
    return t(e).then(
      function (a) {
        return (
          D(e), (a.data = B.call(e, a.data, a.headers, e.transformResponse)), a
        );
      },
      function (a) {
        return (
  ...
  ue = function (e, t) {
    ...
    var n = {},
      ...
      u = ["validateStatus"];
    function s(c, f) {
      return p.isPlainObject(c) && p.isPlainObject(f)
        ? p.merge(c, f)
        : p.isPlainObject(f)
        ? p.merge({}, f)
        : p.isArray(f)
    ...
    function v(c) {
      p.isUndefined(t[c])
        ? p.isUndefined(e[c]) || (n[c] = s(void 0, e[c]))
        : (n[c] = s(e[c], t[c]));
    }
    p.forEach(a, function (f) {
      ...
      p.forEach(i, v),
      p.forEach(o, function (f) {
        p.isUndefined(t[f])
          ? p.isUndefined(e[f]) || (n[f] = s(void 0, e[f]))
          : (n[f] = s(void 0, t[f]));
      }),
...
const lr = "axios",
  ...
  vr = { type: "git", url: "https://github.com/axios/axios.git" },
  yr = ["xhr", "http", "ajax", "promise", "node"],
  br = "Matt Zabriskie",
  wr = "MIT",
  Er = { url: "https://github.com/axios/axios/issues" },
  ...
  Sr = { "./lib/adapters/http.js": "./lib/adapters/xhr.js" },
  Cr = "dist/axios.min.js",
  Or = "dist/axios.min.js",
  Rr = "./index.d.ts",
  Ar = { "follow-redirects": "^1.14.0" },
  $r = [{ path: "./dist/axios.min.js", threshold: "5kB" }];
var Nr = {
    name: lr,
    version: dr,
    description: pr,
...
var Tr = { isOlderVersion: ce, assertOptions: Pr, validators: _ },
  le = h,
  Ur = ae,
  Z = ke,
  Q = cr,
...
C.prototype.request = function (e) {
  ...
  this.interceptors.request.forEach(function (c) {
    (typeof c.runWhen == "function" && c.runWhen(e) === !1) ||
      ((a = a && c.synchronous), n.unshift(c.fulfilled, c.rejected));
  });
  var i = [];
...
C.prototype.getUri = function (e) {
  return (
    (e = T(this.defaults, e)),
    Ur(e.url, e.params, e.paramsSerializer).replace(/^\?/, "")
  );
};
...
le.forEach(["post", "put", "patch"], function (e) {
  C.prototype[e] = function (t, n, a) {
    return this.request(T(a || {}, { method: e, url: t, data: n }));
  };
});
var kr = C;
function J(r) {
...
var Ir = F.exports,
  me = Ir;
const _r = me.create({ baseURL: "https://api.example.com" });
var zr = ve(({ app: r }) => {
  (r.config.globalProperties.$axios = me),
    (r.config.globalProperties.$api = _r);
});
export { _r as api, zr as default };
