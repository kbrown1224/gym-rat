...
const G = {
  ...
  li = [..."0123456789ABCDEF"],
  yo = (i) => li[i & 15],
  vo = (i) => li[(i & 240) >> 4] + li[i & 15],
  ue = (i) => (i & 240) >> 4 === (i & 15),
  Mo = (i) => ue(i.r) && ue(i.g) && ue(i.b) && ue(i.a);
function ko(i) {
  var t = i.length,
    e;
  return (
...
let fe;
function Io(i) {
  fe || ((fe = Fo()), (fe.transparent = [0, 0, 0, 0]));
...
function At(i, t, e, s, n, o = {}) {
  ...
  let l, c;
  for (i.save(), i.font = n.string, Xo(i, o), l = 0; l < a.length; ++l)
    (c = a[l]),
      r &&
...
const qo = new RegExp(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/),
  Go = new RegExp(
...
function j(i, t) {
  ...
  const n = {
    ...
    lineHeight: Zo(C(i.lineHeight, t.lineHeight), e),
    size: e,
    style: s,
...
function ea(i, t, e) {
  ...
  let r = s[t];
  return (
    xt(r) && a.isScriptable(t) && (r = ia(t, r, i, e)),
    z(r) && r.length && (r = sa(t, r, i, a.isIndexable)),
...
const na = (i, t) => (i === !0 ? t : typeof i == "string" ? _t(t, i) : void 0);
...
function Li(i, t, e, s) {
  ...
  return l === null ||
    ...
    ? !1
    : Oi(Array.from(r), [""], n, o, () => aa(t, e, s));
}
function ss(i, t, e, s, n) {
  for (; e; ) e = oa(i, t, e, s, n);
  return e;
}
function aa(i, t, e) {
...
function ra(i, t, e, s) {
  let n;
  for (const o of t)
    if (((n = _n(ta(o, i), e)), tt(n))) return Ai(i, n) ? Li(e, s, i, n) : n;
}
function _n(i, t) {
  for (const e of t) {
    if (!e) continue;
...
function pa(i, t, e, s, n) {
  ...
  if (
    ...
    for (o = 0, a = i.length; o < a; ++o)
      (r = i[o]),
        (l = ha(c, r, i[Math.min(o + 1, a - (s ? 0 : 1)) % a], t.tension)),
        (r.cp1x = l.previous.x),
        (r.cp1y = l.previous.y),
        (r.cp2x = l.next.x),
        (r.cp2y = l.next.y),
...
const ba = ["top", "right", "bottom", "left"];
function Dt(i, t, e) {
  const s = {};
  e = e ? "-" + e : "";
  for (let n = 0; n < 4; n++) {
...
const _a = (i, t, e) => (i > 0 || t > 0) && (!e || !e.shadowRoot);
function xa(i, t) {
  const e = i.touches,
    s = e && e.length ? e[0] : i,
...
function wn(i) {
  return i === "angle"
    ? { between: se, compare: fo, normalize: et }
...
function Oa(i, t, e) {
  ...
  const { property: s, start: n, end: o } = e,
    ...
    { start: h, end: d, loop: u, style: f } = Da(i, t, e),
    g = [];
  let p = !1,
    m = null,
    b,
...
function Ra(i, t) {
  ...
  if (!n) return [];
  const o = !!i._loop,
    { start: a, end: r } = La(e, n, o, s);
  if (s === !0) return cs(i, [{ start: a, end: r, loop: o }], e, t);
  const l = r < a ? r + n : r,
    c = !!i._fullLoop && a === 0 && r === n - 1;
  return cs(i, Ta(e, a, l, c), e, t);
}
function cs(i, t, e, s) {
  return !s || !s.setContext || !e ? t : Ea(i, t, e, s);
}
function Ea(i, t, e, s) {
...
class Ba {
  constructor(t, e, s, n) {
    ...
    (this._active = !0),
      (this._fn = t.fn || za[t.type || typeof a]),
...
const Wa = ["x", "y", "borderWidth", "radius", "tension"],
  Na = ["color", "borderColor", "backgroundColor"];
O.set("animation", {
  delay: void 0,
  duration: 1e3,
  easing: "easeOutQuart",
...
const Va = Object.keys(O.animation);
...
O.set("animations", {
  ...
  numbers: { type: "number", properties: Wa },
});
...
class Sn {
  ...
  _animateOptions(t, e) {
    ...
    return (
      s.$shared &&
        Ha(t.options.$animations, s).then(
          () => {
            t.options = s;
          },
          () => {}
...
class st {
  ...
  _dataCheck() {
    ...
    if (A(e)) this._data = Ua(e);
      ...
      e && Object.isExtensible(e) && bo(e, this),
        (this._syncList = []),
        (this._data = e);
    }
  }
  ...
  _update(t) {
    ...
    this.update(t || "default"),
      (e._clip = $a(
        C(this.options.clip, Ya(e.xScale, e.yScale, this.getMaxOverflow()))
      ));
  }
  update(t) {}
  draw() {
  ...
  getContext(t, e, s) {
    ...
    if (t >= 0 && t < this._cachedMeta.data.length) {
      ...
      (o = a.$context || (a.$context = Za(this.getContext(), t, a))),
      ...
      (o =
        this.$context ||
        (this.$context = Ga(this.chart.getContext(), this.index))),
        (o.dataset = n),
...
function Cn(i, t, e, s) {
  return z(i) ? sr(i, t, e, s) : (t[e.axis] = e.parse(i, s)), t;
}
function _s(i, t, e, s) {
  const n = i.iScale,
    o = i.vScale,
...
function xs(i, t, e, s) {
  return s ? ((i = rr(i, t, e)), (i = ys(i, e, t))) : (i = ys(i, t, e)), i;
}
function rr(i, t, e) {
...
class ze extends st {
  ...
  updateElements(t, e, s, n) {
    ...
    for (let f = e; f < e + s; f++) {
      ...
      ar(_, y, b, a), lr(_, y, h.ratio), this.updateElement(t[f], f, _, n);
    }
  }
  _getStacks(t, e) {
  ...
  _calculateBarIndexPixels(t, e) {
    ...
    if (e.grouped) {
      const c = o ? this._getStackCount(t) : e.stackCount,
        h = n.barThickness === "flex" ? ir(t, e, n, c) : er(t, e, n, c),
...
class Vt extends st {
  ...
  update(t) {
    const e = this.chart,
      ...
      l = Math.min(io(this.options.cutout, r), 1),
      c = this._getRingWeight(this.index),
      { circumference: h, rotation: d } = this._getRotationExtents(),
      { ratioX: u, ratioY: f, offsetX: g, offsetY: p } = cr(d, h, l),
      m = (s.width - a) / u,
      b = (s.height - a) / f,
...
const On = {
  ...
  numeric(i, t, e) {
    ...
    if (e.length > 1) {
      ...
      (c < 1e-4 || c > 1e15) && (n = "scientific"), (o = hr(i, e));
    }
...
function dr(i, t) {
  const e = i.options.ticks,
    s = e.maxTicksLimit || ur(i),
    n = e.major.enabled ? gr(t) : [],
    o = n.length,
    a = n[0],
    r = n[o - 1],
    l = [];
  if (o > s) return pr(t, l, n, o / s), l;
  const c = fr(n, t, s);
  if (o > 0) {
    let h, d;
...
const br = (i) => (i === "left" ? "right" : i === "right" ? "left" : i),
...
function Mr(i, t, e) {
  let s = Mi(i);
  return ((e && t !== "right") || (!e && t === "right")) && (s = br(s)), s;
}
function kr(i, t, e, s) {
...
class Lt extends nt {
  ...
  getPixelForDecimal(t) {
    ...
    return go(this._alignToPixels ? Mt(this.chart, e, 0) : e);
  }
  ...
  getContext(t) {
    ...
    if (t >= 0 && t < e.length) {
      const s = e[t];
      return s.$context || (s.$context = vr(this.getContext(), t, s));
    }
    return this.$context || (this.$context = yr(this.chart.getContext(), this));
  }
  _tickSize() {
...
function wr(i, t, e) {
  ...
  O.set(t, s),
    i.defaultRoutes && Sr(t, i.defaultRoutes),
...
function Or(i, t, e, s) {
  ...
  if (r && t === r.axis && t !== "r" && a && o.length) {
    const l = r._reversePixels ? po : Pt;
    if (s) {
      if (n._sharedOptions) {
        const c = o[0],
...
function Gt(i, t, e, s) {
  ...
  for (o = 0, a = i.length, c = 0; o < a; ++o) {
    (r = i[o]),
      (l = r.box),
      l.update(r.width || t.w, r.height || t.h, Nr(r.horizontal, t));
...
class Qr extends Tn {
  ...
  addEventListener(t, e, s) {
    ...
    const n = t.$proxies || (t.$proxies = {}),
      a = { attach: Xr, detach: Kr, resize: Zr }[e] || Jr;
    n[e] = a(t, e, s);
  }
  removeEventListener(t, e) {
    const s = t.$proxies || (t.$proxies = {}),
      n = s[e];
    if (!n) return;
    (({ attach: ni, detach: ni, resize: ni }[e] || $r)(t, e, n),
      (s[e] = void 0));
  }
  getDevicePixelRatio() {
...
function nl(i, { plugins: t, localIds: e }, s, n) {
  ...
  for (const r of t) {
    ...
    c !== null &&
      o.push({
        plugin: r,
        options: ol(i.config, { plugin: r, local: e[l] }, c, a),
      });
  }
  return o;
}
...
function fi(i, t) {
  return i === "x" || i === "y"
    ? i
    : t.axis || ll(t.position) || i.charAt(0).toLowerCase();
}
function cl(i, t) {
...
function Fn(i) {
  ...
  (t.plugins = C(t.plugins, {})), (t.scales = cl(i, t));
}
function In(i) {
  return (
    (i = i || {}),
...
function fl(i, t) {
  ...
  for (const n of t) {
    const o = e(n),
      a = s(n),
      r = (a || o) && i[n];
    if ((o && (xt(r) || ul(r))) || (a && z(r))) return !0;
  }
  return !1;
}
var gl = "3.9.1";
const pl = ["top", "bottom", "left", "right", "chartArea"];
function Ts(i, t) {
...
class Ee {
  constructor(t, e) {
    ...
    (this.platform = new (s.platform || tl(n))()),
    ...
    if (
      ...
      (this.scales = {}),
      (this._plugins = new el()),
      (this.$proxies = {}),
      (this._hiddenIndices = {}),
      (this.attached = !1),
      (this._animationsDisabled = void 0),
      (this.$context = void 0),
      (this._doResize = _o((d) => this.update(d), a.resizeDelay || 0)),
      (this._dataChanges = []),
      (Re[this.id] = this),
      !r || !l)
    ) {
...
Object.defineProperties(Ee, {
  ...
  version: { enumerable: ft, value: gl },
...
function yl(i, t, e, s) {
  const n = xl(i.options.borderRadius),
    o = (e - t) / 2,
    a = Math.min(o, (s * t) / 2),
    r = (l) => {
...
class zi extends nt {
  ...
  draw(t) {
    ...
    const l = vl(t, this, r, o, a);
    kl(t, this, r, o, l, a), t.restore();
  }
}
zi.id = "arc";
zi.defaults = {
...
function Tl(i, t, e, s) {
  Ll && !t.options.segment ? Ol(i, t, e, s) : Al(i, t, e, s);
}
class Ne extends nt {
  constructor(t) {
    super(),
  ...
  get segments() {
    return this._segments || (this._segments = Ra(this, this.options.segment));
  }
  first() {
  ...
  interpolate(t, e) {
    const s = this.options,
      n = t[e],
      o = this.points,
      a = Aa(this, { property: e, start: n, end: n });
    if (!a.length) return;
    const r = [],
      l = Dl(s);
    let c, h;
  ...
  draw(t, e, s, n) {
    ...
    (this.points || []).length &&
      o.borderWidth &&
      (t.save(), Tl(t, this, s, n), t.restore()),
...
class Bs extends nt {
  ...
  _draw() {
    ...
    this.legendItems.forEach((M, S) => {
      ...
      const K = l.x(D);
      _(K, V, M),
        (D = xo(L, D + p + f, v ? D + T : this.right, t.rtl)),
        y(l.x(D), V, M),
        v ? (g.x += T + d) : (g.y += k);
    }),
...
function Ns(i, t, e) {
  ...
  return { xAlign: e.xAlign || t.xAlign || Yl(i, t, e, s), yAlign: s };
}
function $l(i, t) {
  let { x: e, width: s } = i;
...
class mi extends nt {
  ...
  getContext() {
    return (
      this.$context ||
      (this.$context = Xl(this.chart.getContext(), this, this._tooltipItems))
    );
  }
  getTitle(t, e) {
    const { callbacks: s } = e,
  ...
  _createItems(t) {
    ...
    let r = [],
      l,
      c;
    for (l = 0, c = e.length; l < c; ++l) r.push(Vl(this.chart, e[l]));
    return (
...
const Gl = (i, t) => (i === null ? null : U(Math.round(i), 0, t));
class bi extends Lt {
  constructor(t) {
    super(t),
  ...
  parse(t, e) {
    ...
    return (
      (e =
        isFinite(e) && s[e] === t ? e : ql(s, t, C(e, t), this._addedLabels)),
      Gl(e, s.length - 1)
    );
  }
  determineDataLimits() {
...
function Ql(i, t, e) {
  return (
    (e = z(e) ? e : [e]), { w: Yo(i, t.string, e), h: e.length * t.lineHeight }
  );
}
...
class Ve extends Fe {
  ...
  drawGrid() {
    ...
    let a, r, l;
    if (
      (e.pointLabels.display && ac(this, o),
      n.display &&
...
class je extends Lt {
  ...
  buildTicks() {
    ...
    return (
      ...
      (this._majorUnit =
        !s.major.enabled || this._unit === "year" ? void 0 : dc(this._unit)),
      this.initOffsets(n),
      t.reverse && r.reverse(),
...
const _c =
  ...
  xc = "Update ERROR: chart instance not found",
  Ni = (i, t, e) =>
    Gn({
      props: {
      ...
      setup(s, n) {
          ...
          if (Object.keys(g).length > 0) {
            ...
            bc(f, g) && p !== null
              ? (qn(p == null ? void 0 : p.data, f, s.datasetIdKey),
                f.labels !== void 0 && pc(p, f.labels, n),
                h())
        ...
        function c(d) {
          const u = ut(o.value);
          u !== null ? (mc(u, d), h()) : ke(r, s.chartData, s.chartOptions, n);
        }
        function h() {
          const d = ut(o.value);
          d !== null ? fc(d, n) : console.error(xc);
        }
        return (
          Vi(
            () => s.chartData,
  ...
  wc = Ni("bar-chart", "bar", ze),
  Sc = Ni("doughnut-chart", "doughnut", Vt),
  Pc = Ni("line-chart", "line", Be);
export {
  zi as A,
  Wi as B,
  Ee as C,
