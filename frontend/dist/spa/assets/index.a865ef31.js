...
function Mc() {
  if (window.getSelection !== void 0) {
    ...
    i.empty !== void 0
      ? i.empty()
      : i.removeAllRanges !== void 0 &&
        (i.removeAllRanges(),
        Gn.is.mobile !== !0 && i.addRange(document.createRange()));
  } else document.selection !== void 0 && document.selection.empty();
}
function kc(i, t, e) {
  return e <= t ? t : Math.min(e, Math.max(t, i));
}
function wc(i, t, e) {
  if (e <= t) return t;
  const s = e - t + 1;
  let n = t + ((i - t) % s);
  return n < t && (n = s + n), n === 0 ? 0 : n;
}
/*!
 * Chart.js v3.9.1
...
const Y = (i) => (typeof i == "number" || i instanceof Number) && isFinite(+i);
function Z(i, t) {
  return Y(i) ? i : t;
}
function C(i, t) {
...
function Ce(i) {
  if (z(i)) return i.map(Ce);
  if (A(i)) {
    const t = Object.create(null),
      e = Object.keys(i),
      s = e.length;
    let n = 0;
    for (; n < s; ++n) t[e[n]] = Ce(i[e[n]]);
    return t;
  }
  return i;
}
...
function oo(i, t, e) {
  ...
  A(s) && A(n)
    ? Zt(s, n)
    : Object.prototype.hasOwnProperty.call(t, i) || (t[i] = Ce(n));
}
const ji = { "": (i) => i, x: (i) => i.x, y: (i) => i.y };
function _t(i, t) {
  return (ji[t] || (ji[t] = ao(t)))(i);
}
function ao(i) {
  const t = ro(i);
  return (e) => {
...
function Ui(i) {
  ...
  i = Jt(i, t, i / 1e3) ? t : i;
  const e = Math.pow(10, Math.floor(J(i))),
    s = i / e;
...
const Pt = (i, t, e, s) =>
    vi(i, e, s ? (n) => i[n][t] <= e : (n) => i[n][t] < e),
  mo = (i, t, e) => vi(i, e, (s) => i[s][t] >= e);
function bo(i, t, e) {
  let s = 0,
    n = i.length;
  for (; s < n && i[s] < t; ) s++;
...
const en = ["push", "pop", "shift", "splice", "unshift"];
function _o(i, t) {
  if (i._chartjs) {
...
function on(i, t, e) {
  const s = e || ((a) => Array.prototype.slice.call(a));
  let n = !1,
    o = [];
  return function (...a) {
    (o = s(a)),
...
const Mi = (i) => (i === "start" ? "left" : i === "end" ? "right" : "center"),
  $ = (i, t, e) => (i === "start" ? t : i === "end" ? e : (t + e) / 2),
  yo = (i, t, e, s) =>
  ...
  if (i._sorted) {
    ...
    d &&
      (n = U(
        Math.min(
          Pt(r, a.axis, c).lo,
          e ? s : Pt(t, l, a.getPixelForValue(c)).lo
        ),
        0,
        s - 1
      )),
      u
        ? (o =
            U(
              Math.max(
                Pt(r, a.axis, h, !0).hi + 1,
                e ? 0 : Pt(t, l, a.getPixelForValue(h), !0).hi + 1
              ),
              n,
              s
            ) - n)
...
const de = (i) => i === 0 || i === 1,
  qi = (i, t, e) => -(Math.pow(2, 10 * (i -= 1)) * Math.sin(((i - t) * F) / e)),
  Gi = (i, t, e) => Math.pow(2, -10 * i) * Math.sin(((i - t) * F) / e) + 1,
  Qt = {
    linear: (i) => i,
    easeInQuad: (i) => i * i,
    easeOutQuad: (i) => -i * (i - 2),
    ...
    easeInElastic: (i) => (de(i) ? i : qi(i, 0.075, 0.3)),
    easeOutElastic: (i) => (de(i) ? i : Gi(i, 0.075, 0.3)),
    easeInOutElastic(i) {
      return de(i)
        ? i
        : i < 0.5
        ? 0.5 * qi(i * 2, 0.1125, 0.45)
        : 0.5 + 0.5 * Gi(i * 2 - 1, 0.1125, 0.45);
    },
    easeInBack(i) {
...
function qt(i) {
  return pt(re(i * 2.55), 0, 255);
}
function bt(i) {
  return pt(re(i * 255), 0, 255);
}
function dt(i) {
  return pt(re(i / 2.55) / 100, 0, 1);
}
function Zi(i) {
...
const G = {
  ...
  li = [..."0123456789ABCDEF"],
  vo = (i) => li[i & 15],
  Mo = (i) => li[(i & 240) >> 4] + li[i & 15],
  ue = (i) => (i & 240) >> 4 === (i & 15),
  ko = (i) => ue(i.r) && ue(i.g) && ue(i.b) && ue(i.a);
function wo(i) {
  var t = i.length,
    e;
  return (
...
function Eo(i, t) {
  var e = ki(i);
  (e[0] = cn(e[0] + t)), (e = Si(e)), (i.r = e[0]), (i.g = e[1]), (i.b = e[2]);
}
function Fo(i) {
  if (!i) return;
  const t = ki(i),
...
let fe;
function zo(i) {
  fe || ((fe = Io()), (fe.transparent = [0, 0, 0, 0]));
...
function Wo(i) {
  ...
  if (!!t) {
    if (t[7] !== s) {
      const a = +t[7];
      e = t[8] ? qt(a) : pt(a * 255, 0, 255);
    }
    return (
      (s = +t[1]),
      (n = +t[3]),
      (o = +t[5]),
      (s = 255 & (t[2] ? qt(s) : pt(s, 0, 255))),
      (n = 255 & (t[4] ? qt(n) : pt(n, 0, 255))),
      (o = 255 & (t[6] ? qt(o) : pt(o, 0, 255))),
      { r: s, g: n, b: o, a: e }
    );
  }
}
function No(i) {
  return (
    i &&
    (i.a < 255
      ? `rgba(${i.r}, ${i.g}, ${i.b}, ${dt(i.a)})`
      : `rgb(${i.r}, ${i.g}, ${i.b})`)
  );
}
const qe = (i) =>
    i <= 0.0031308 ? i * 12.92 : Math.pow(i, 1 / 2.4) * 1.055 - 0.055,
  Et = (i) => (i <= 0.04045 ? i / 12.92 : Math.pow((i + 0.055) / 1.055, 2.4));
function Vo(i, t, e) {
  const s = Et(dt(i.r)),
    n = Et(dt(i.g)),
    o = Et(dt(i.b));
  return {
    r: bt(qe(s + e * (Et(dt(t.r)) - s))),
    g: bt(qe(n + e * (Et(dt(t.g)) - n))),
    b: bt(qe(o + e * (Et(dt(t.b)) - o))),
    a: i.a + e * (t.a - i.a),
  };
}
function ge(i, t, e) {
  ...
  return (
    Array.isArray(i)
      ? i.length >= 3 &&
        ...
        i.length > 3 && (t.a = bt(i[3])))
      : ((t = hn(i, { r: 0, g: 0, b: 0, a: 1 })), (t.a = bt(t.a))),
    t
  );
}
function Ho(i) {
  return i.charAt(0) === "r" ? Wo(i) : Ro(i);
}
class Oe {
  constructor(t) {
  ...
  greyscale() {
    const t = this._rgb,
      e = re(t.r * 0.3 + t.g * 0.59 + t.b * 0.11);
...
function Ge(i) {
  return un(i) ? i : dn(i).saturate(0.5).darken(0.1).hexString();
}
...
class jo {
  constructor(t) {
    (this.animation = void 0),
      ...
      (this.hover = {}),
      (this.hoverBackgroundColor = (e, s) => Ge(s.backgroundColor)),
      (this.hoverBorderColor = (e, s) => Ge(s.borderColor)),
      (this.hoverColor = (e, s) => Ge(s.color)),
      (this.indexAxis = "x"),
      (this.interaction = {
        mode: "nearest",
        intersect: !0,
...
function $o(i, t, e, s) {
  ...
  let l, c, h, d, u;
  for (l = 0; l < r; l++)
    if (((d = e[l]), d != null && z(d) !== !0)) a = Ae(i, n, o, a, d);
    else if (z(d))
      for (c = 0, h = d.length; c < h; c++)
        (u = d[c]), u != null && !z(u) && (a = Ae(i, n, o, a, u));
  i.restore();
  const f = o.length / 2;
  if (f > e.length) {
    ...
    switch ((i.beginPath(), d)) {
      ...
      case "rectRounded":
        (c = f * 0.516),
          ...
          (a = Math.cos(g + jt) * l),
          (r = Math.sin(g + jt) * l),
          i.arc(e - a, s - r, c, g - B, g - W),
          i.arc(e + r, s - a, c, g - W, g),
          i.arc(e + a, s + r, c, g, g + W),
          i.arc(e - r, s + a, c, g + W, g + B),
          i.closePath();
        break;
      case "rect":
        if (!u) {
...
function Ko(i, t) {
  t.translation && i.translate(t.translation[0], t.translation[1]),
    R(t.rotation) || i.rotate(t.rotation),
...
function oe(i, t) {
  ...
  i.arc(e + a.topLeft, s + a.topLeft, a.topLeft, -W, B, !0),
    i.lineTo(e, s + o - a.bottomLeft),
    i.arc(e + a.bottomLeft, s + o - a.bottomLeft, a.bottomLeft, B, W, !0),
    ...
    i.arc(e + n - a.topRight, s + a.topRight, a.topRight, 0, -W, !0),
    i.lineTo(e + a.topLeft, s);
}
const Go = new RegExp(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/),
  Zo = new RegExp(
...
function Di(i, t) {
  const e = {},
    s = A(t),
    n = s ? Object.keys(t) : t,
    o = A(i) ? (s ? (a) => C(i[a], i[t[a]]) : (a) => i[a]) : () => i;
  for (const a of n) e[a] = Qo(o(a));
  return e;
}
function gn(i) {
...
function j(i, t) {
  ...
  const n = {
    ...
    lineHeight: Jo(C(i.lineHeight, t.lineHeight), e),
    size: e,
    style: s,
...
function pn(i, t = { scriptable: !0, indexable: !0 }) {
  const {
...
function ia(i, t, e) {
  ...
  let r = s[t];
  return (
    xt(r) && a.isScriptable(t) && (r = sa(t, r, i, e)),
    z(r) && r.length && (r = na(t, r, i, a.isIndexable)),
    Ai(t, r) && (r = Bt(r, n, o && o[t], a)),
    r
  );
}
function sa(i, t, e, s) {
  ...
  return (
    ...
    (t = t(o, a || s)),
    r.delete(i),
    Ai(i, t) && (t = Li(n._scopes, n, i, t)),
    t
  );
}
function na(i, t, e, s) {
  const { _proxy: n, _context: o, _subProxy: a, _descriptors: r } = e;
  if (tt(o.index) && s(i)) t = t[o.index % t.length];
  else if (A(t[0])) {
    const l = t,
...
const oa = (i, t) => (i === !0 ? t : typeof i == "string" ? _t(t, i) : void 0);
function aa(i, t, e, s, n) {
  for (const o of t) {
    const a = oa(e, o);
    if (a) {
      i.add(a);
      const r = bn(a._fallback, e, n);
      if (tt(r) && r !== e && r !== s) return r;
    } else if (a === !1 && tt(s) && e !== s) return null;
  }
  return !1;
}
function Li(i, t, e, s) {
  const n = t._rootScopes,
    ...
    r = new Set();
  r.add(s);
  let l = ss(r, a, e, o || e, s);
  return l === null ||
    (tt(o) && o !== e && ((l = ss(r, a, o, l, s)), l === null))
    ? !1
    : Oi(Array.from(r), [""], n, o, () => ra(t, e, s));
}
function ss(i, t, e, s, n) {
  for (; e; ) e = aa(i, t, e, s, n);
  return e;
}
function ra(i, t, e) {
...
function la(i, t, e, s) {
  let n;
  for (const o of t)
    if (((n = _n(ea(o, i), e)), tt(n))) return Ai(i, n) ? Li(e, s, i, n) : n;
}
function _n(i, t) {
  for (const e of t) {
    if (!e) continue;
...
function fa(i, t, e = "x") {
  ...
  let o,
    ...
    l = Wt(i, 0);
  for (let c = 0; c < n; ++c) {
    if (((a = r), (r = l), (l = Wt(i, c + 1)), !r)) continue;
    const h = r[e],
      d = r[s];
    a &&
      ((o = (h - a[e]) / 3),
...
function ma(i, t, e, s, n) {
  ...
  if (
    ...
    for (o = 0, a = i.length; o < a; ++o)
      (r = i[o]),
        (l = da(c, r, i[Math.min(o + 1, a - (s ? 0 : 1)) % a], t.tension)),
        (r.cp1x = l.previous.x),
        (r.cp1y = l.previous.y),
        (r.cp2x = l.next.x),
        (r.cp2y = l.next.y),
...
const Ie = (i) => window.getComputedStyle(i, null);
function ba(i, t) {
  return Ie(i).getPropertyValue(t);
}
const _a = ["top", "right", "bottom", "left"];
function Dt(i, t, e) {
  const s = {};
  e = e ? "-" + e : "";
  for (let n = 0; n < 4; n++) {
  ...
  if (t === void 0 || e === void 0) {
    ...
    if (!o) (t = i.clientWidth), (e = i.clientHeight);
      ...
      (t = a.width - c.width - l.width),
        ...
        (s = Le(r.maxWidth, o, "clientWidth")),
        (n = Le(r.maxHeight, o, "clientHeight"));
    }
  }
  return { width: t, height: e, maxWidth: s || De, maxHeight: n || De };
}
const Je = (i) => Math.round(i * 10) / 10;
function Ma(i, t, e, s) {
  const n = Ie(i),
    o = Dt(n, "margin"),
    a = Le(n.maxWidth, i, "clientWidth") || De,
    r = Le(n.maxHeight, i, "clientHeight") || De,
    l = va(i, t, e);
  let { width: c, height: h } = l;
  if (n.boxSizing === "content-box") {
    const d = Dt(n, "border", "width"),
      u = Dt(n, "padding");
  ...
  return (
    ...
    (c = Je(Math.min(c, a, l.maxWidth))),
    (h = Je(Math.min(h, r, l.maxHeight))),
    c && !h && (h = Je(c / 2)),
    { width: c, height: h }
  );
}
...
function wn(i) {
  return i === "angle"
    ? { between: se, compare: go, normalize: et }
    : { between: gt, compare: (t, e) => t - e, normalize: (t) => t };
}
...
function Aa(i, t, e) {
  ...
  const { property: s, start: n, end: o } = e,
    a = t.length,
    { compare: r, between: l, normalize: c } = wn(s),
    { start: h, end: d, loop: u, style: f } = Oa(i, t, e),
    g = [];
  let p = !1,
    m = null,
    b,
  ...
  for (let S = h, w = h; S <= d; ++S)
    (_ = t[S % a]),
      !_.skip &&
        ...
        b !== y &&
          ((p = l(b, n, o)),
          m === null && k() && (m = r(b, n) === 0 ? S : w),
          m !== null &&
            M() &&
            (g.push(ls({ start: m, end: S, loop: u, count: a, style: f })),
            (m = null)),
          (w = S),
          (y = b)));
  return (
    m !== null && g.push(ls({ start: m, end: d, loop: u, count: a, style: f })),
    g
  );
}
function La(i, t) {
...
function Ea(i, t) {
  ...
  if (s === !0) return cs(i, [{ start: a, end: r, loop: o }], e, t);
  const l = r < a ? r + n : r,
    c = !!i._fullLoop && a === 0 && r === n - 1;
  return cs(i, Ra(e, a, l, c), e, t);
}
function cs(i, t, e, s) {
  return !s || !s.setContext || !e ? t : Fa(i, t, e, s);
}
function Fa(i, t, e, s) {
...
class Wa {
  constructor(t, e, s, n) {
    ...
    (this._active = !0),
      (this._fn = t.fn || Ba[t.type || typeof a]),
...
const Na = ["x", "y", "borderWidth", "radius", "tension"],
  Va = ["color", "borderColor", "backgroundColor"];
O.set("animation", {
  delay: void 0,
  duration: 1e3,
  easing: "easeOutQuart",
...
const Ha = Object.keys(O.animation);
...
O.set("animations", {
  colors: { type: "color", properties: Va },
  numbers: { type: "number", properties: Na },
});
...
class Sn {
  ...
  configure(t) {
    ...
    Object.getOwnPropertyNames(t).forEach((s) => {
      ...
      if (!A(n)) return;
      const o = {};
      for (const a of Ha) o[a] = n[a];
      ((z(n.properties) && n.properties) || [s]).forEach((a) => {
  ...
  _animateOptions(t, e) {
    ...
    return (
      s.$shared &&
        ja(t.options.$animations, s).then(
          () => {
            t.options = s;
          },
          () => {}
  ...
  update(t, e) {
    ...
    if (s.length) return ct.add(this._chart, s), !0;
  }
}
function ja(i, t) {
  const e = [],
...
function fs(i, t, e, s = {}) {
  ...
  if (t !== null) {
    for (a = 0, r = n.length; a < r; ++a) {
      ...
      (c = i.values[l]), Y(c) && (o || t === 0 || rt(t) === rt(c)) && (t += c);
    }
    return t;
  }
}
...
const ti = (i) => i === "reset" || i === "none",
  bs = (i, t) => (t ? i : Object.assign({}, i)),
  Qa = (i, t, e) =>
    i && !t.hidden && t._stacked && { keys: Pn(e, !0), values: null };
class st {
  constructor(t, e) {
    (this.chart = t),
      (this._ctx = t.ctx),
  ...
  linkScales() {
    const t = this.chart,
      ...
      o = (e.xAxisID = C(s.xAxisID, Qe(t, "x"))),
      a = (e.yAxisID = C(s.yAxisID, Qe(t, "y"))),
      r = (e.rAxisID = C(s.rAxisID, Qe(t, "r"))),
      l = e.indexAxis,
  ...
  _destroy() {
    const t = this._cachedMeta;
    this._data && Ki(this._data, this), t._stacked && Yt(t);
  }
  _dataCheck() {
    const t = this.getDataset(),
      e = t.data || (t.data = []),
      s = this._data;
    if (A(e)) this._data = Xa(e);
    else if (s !== e) {
      if (s) {
        Ki(s, this);
      ...
      e && Object.isExtensible(e) && _o(e, this),
        (this._syncList = []),
        (this._data = e);
    }
  }
  ...
  buildOrUpdateElements(t) {
    ...
    (e._stacked = gs(e.vScale, e)),
      e.stack !== s.stack && ((n = !0), Yt(e), (e.stack = s.stack)),
      this._resyncElements(t),
      (n || o !== e._stacked) && ms(this, e._parsed);
  }
  configure() {
  ...
  applyStack(t, e, s) {
    const n = this.chart,
      o = this._cachedMeta,
      a = e[t.axis],
      r = { keys: Pn(n, !0), values: e._stacks[t.axis] };
    return fs(r, a, o.index, { mode: s });
  }
  updateRangeFromParsed(t, e, s, n) {
    const o = s[e.axis];
    let a = o === null ? NaN : o;
    const r = n && s._stacks[e.axis];
    n && r && ((n.values = r), (a = fs(n, o, this._cachedMeta.index))),
  ...
  getAllParsedValues(t) {
    const e = this._cachedMeta._parsed,
      s = [];
    let n, o, a;
    for (n = 0, o = e.length; n < o; ++n) (a = e[n][t.axis]), Y(a) && s.push(a);
    return s;
  }
  getMaxOverflow() {
    return !1;
  ...
  _update(t) {
    ...
    this.update(t || "default"),
      (e._clip = Ua(
        C(this.options.clip, $a(e.xScale, e.yScale, this.getMaxOverflow()))
      ));
  }
  update(t) {}
  draw() {
  ...
  getContext(t, e, s) {
    ...
    if (t >= 0 && t < this._cachedMeta.data.length) {
      ...
      (o = a.$context || (a.$context = Ja(this.getContext(), t, a))),
      ...
      (o =
        this.$context ||
        (this.$context = Za(this.chart.getContext(), this.index))),
        (o.dataset = n),
  ...
  _resolveElementOptions(t, e = "default", s) {
    const n = e === "active",
      ...
      a = t + "-" + e,
      r = o[a],
      l = this.enableOptionSharing && tt(s);
    if (r) return bs(r, l);
    ...
    return p.$shared && ((p.$shared = l), (o[a] = Object.freeze(bs(p, l)))), p;
  }
  ...
  _getSharedOptions(t, e) {
    ...
    return (
      this.updateSharedOptions(o, e, s), { sharedOptions: o, includeOptions: a }
    );
  }
...
function tr(i, t) {
  if (!i._cache.$bar) {
    ...
    i._cache.$bar = sn(s.sort((n, o) => n - o));
  }
  return i._cache.$bar;
}
function er(i) {
  ...
  const l = () => {
    a === 32767 ||
      a === -32768 ||
      (tt(r) && (s = Math.min(s, Math.abs(a - r) || s)), (r = a));
  };
...
function Cn(i, t, e, s) {
  return z(i) ? nr(i, t, e, s) : (t[e.axis] = e.parse(i, s)), t;
}
function _s(i, t, e, s) {
  const n = i.iScale,
    o = i.vScale,
...
function or(i, t, e) {
  return i !== 0 ? rt(i) : (t.isHorizontal() ? 1 : -1) * (t.min >= e ? 1 : -1);
}
function ar(i) {
  let t, e, s, n, o;
  return (
...
function rr(i, t, e, s) {
  ...
  const { start: a, end: r, reverse: l, top: c, bottom: h } = ar(i);
  n === "middle" &&
    e &&
...
function xs(i, t, e, s) {
  return s ? ((i = lr(i, t, e)), (i = ys(i, e, t))) : (i = ys(i, t, e)), i;
}
function lr(i, t, e) {
...
class ze extends st {
    ...
    for (let f = e; f < e + s; f++) {
      const g = this.getParsed(f),
        ...
        _ = {
          ...
          base: p.base,
          enableBorderRadius:
            !b || ei(g._custom) || a === b._top || a === b._bottom,
          x: c ? p.head : m.center,
          y: c ? m.center : p.head,
      ...
      rr(_, y, b, a), cr(_, y, h.ratio), this.updateElement(t[f], f, _, n);
    }
  }
  _getStacks(t, e) {
  ...
  _calculateBarValuePixels(t) {
    ...
    if (m === e.getPixelForValue(a)) {
      const b = (rt(g) * e.getLineWidthForValue(a)) / 2;
      (m += b), (g -= b);
    }
  ...
  _calculateBarIndexPixels(t, e) {
    ...
    if (e.grouped) {
      const c = o ? this._getStackCount(t) : e.stackCount,
        h = n.barThickness === "flex" ? sr(t, e, n, c) : ir(t, e, n, c),
...
class Ri extends st {
  ...
  resolveDataElementOptions(t, e) {
    ...
    const o = n.radius;
    return (
      e !== "active" && (n.radius = 0), (n.radius += C(s && s._custom, o)), n
    );
  }
}
Ri.id = "bubble";
...
function hr(i, t, e) {
  ...
  if (t < F) {
    const r = i,
      ...
      d = Math.cos(l),
      u = Math.sin(l),
      f = (y, v, x) => (se(y, r, l, !0) ? 1 : Math.max(v, v * e, x, x * e)),
      g = (y, v, x) => (se(y, r, l, !0) ? -1 : Math.min(v, v * e, x, x * e)),
      p = f(0, c, d),
      m = f(W, h, u),
      b = g(B, c, d),
      _ = g(B + W, h, u);
...
class Vt extends st {
  ...
  update(t) {
    const e = this.chart,
      ...
      l = Math.min(so(this.options.cutout, r), 1),
      c = this._getRingWeight(this.index),
      { circumference: h, rotation: d } = this._getRotationExtents(),
      { ratioX: u, ratioY: f, offsetX: g, offsetY: p } = hr(d, h, l),
      m = (s.width - a) / u,
      b = (s.height - a) / f,
      _ = Math.max(Math.min(m, b) / 2, 0),
      y = Zs(this.options.radius, _),
      v = Math.max(y * l, 0),
  ...
  updateElements(t, e, s, n) {
    ...
    for (_ = e; _ < e + s; ++_) {
      ...
      m &&
        (x.options =
          p || this.resolveDataElementOptions(_, v.active ? "active" : n)),
        (b += y),
  ...
  getLabelAndValue(t) {
    const e = this._cachedMeta,
      s = this.chart,
      n = s.data.labels || [],
      o = le(e._parsed[t], s.options.locale);
        ...
        generateLabels(i) {
          ...
          if (t.labels.length && t.datasets.length) {
            ...
            return t.labels.map((s, n) => {
              const a = i.getDatasetMeta(0).controller.getStyle(n);
              return {
                text: s,
  ...
  updateElements(t, e, s, n) {
    ...
    for (let y = e; y < e + s; ++y) {
      const v = t[y],
        ...
        k = b ? v : {},
        M = R(x[f]),
        S = (k[u] = a.getPixelForValue(x[u], y)),
        w = (k[f] =
          o || M
            ? r.getBasePixel()
            : r.getPixelForValue(l ? this.applyStack(r, x, l) : x[f], y));
      (k.skip = isNaN(S) || isNaN(w) || M),
        (k.stop = y > 0 && Math.abs(x[u] - _[u]) > m),
        p && ((k.parsed = x), (k.raw = c.data[y])),
        d &&
          (k.options =
            h || this.resolveDataElementOptions(y, v.active ? "active" : n)),
        b || this.updateElement(v, y, k, n),
        (_ = x);
    }
  }
  getMaxOverflow() {
...
class Ei extends st {
  ...
  getLabelAndValue(t) {
    const e = this._cachedMeta,
      s = this.chart,
      n = s.data.labels || [],
      o = le(e._parsed[t].r, s.options.locale);
    return { label: n[t] || "", value: o };
  }
  parseObjectData(t, e, s, n) {
    return xn.bind(this)(t, e, s, n);
  }
  update(t) {
    const e = this._cachedMeta.data;
  ...
  _computeAngle(t, e, s) {
    return this.chart.getDataVisibility(t)
      ? it(this.resolveDataElementOptions(t, e).angle || s)
      : 0;
  }
}
Ei.id = "polarArea";
...
Fi.overrides = { aspectRatio: 1, scales: { r: { type: "radialLinear" } } };
class nt {
  constructor() {
    (this.x = void 0),
      (this.y = void 0),
...
const On = {
  ...
  numeric(i, t, e) {
    ...
    if (e.length > 1) {
      ...
      (c < 1e-4 || c > 1e15) && (n = "scientific"), (o = dr(i, e));
    }
    const a = J(Math.abs(o)),
  ...
  logarithmic(i, t, e) {
    if (i === 0) return "0";
    const s = i / Math.pow(10, Math.floor(J(i)));
    return s === 1 || s === 2 || s === 5 ? On.numeric.call(this, i, t, e) : "";
  },
};
function dr(i, t) {
...
function ur(i, t) {
  const e = i.options.ticks,
    s = e.maxTicksLimit || fr(i),
    n = e.major.enabled ? pr(t) : [],
    o = n.length,
    a = n[0],
    r = n[o - 1],
    l = [];
  ...
  if (o > 0) {
    ...
    for (be(t, l, c, R(u) ? 0 : a - u, a), h = 0, d = o - 1; h < d; h++)
      be(t, l, c, n[h], n[h + 1]);
    return be(t, l, c, r, R(u) ? t.length : r + u), l;
  }
  return be(t, l, c), l;
}
function fr(i) {
...
const _r = (i) => (i === "left" ? "right" : i === "right" ? "left" : i),
  vs = (i, t, e) => (t === "top" || t === "left" ? i[t] + e : i[t] - e);
function Ms(i, t) {
  const e = [],
    s = i.length / t,
    n = i.length;
...
function kr(i, t, e) {
  let s = Mi(i);
  return ((e && t !== "right") || (!e && t === "right")) && (s = _r(s)), s;
}
function wr(i, t, e, s) {
  ...
  if (i.isHorizontal()) {
    if (((f = $(s, o, r)), A(e))) {
      ...
      e === "center" ? (g = (c.bottom + c.top) / 2 + p - t) : (g = vs(i, e, t));
    u = r - o;
  } else {
    if (A(e)) {
      const b = Object.keys(e)[0],
      ...
      e === "center" ? (f = (c.left + c.right) / 2 - m + t) : (f = vs(i, e, t));
    (g = $(s, a, n)), (d = e === "left" ? -W : W);
  }
...
class Lt extends nt {
  ...
  getUserBounds() {
    ...
    return (
      ...
      { min: Z(t, s), max: Z(e, n), minDefined: Y(t), maxDefined: Y(e) }
    );
  }
  getMinMax(t) {
  ...
  update(t, e, s) {
    ...
    this.beforeUpdate(),
      ...
      this._dataLimitsCached ||
        ...
        (this._range = ta(this, o, n)),
        (this._dataLimitsCached = !0)),
      this.beforeBuildTicks(),
      (this.ticks = this.buildTicks() || []),
      this.afterBuildTicks();
    const l = r < this.ticks.length;
    this._convertTicksToLabels(l ? Ms(this.ticks, r) : this.ticks),
      this.configure(),
    ...
    (r = t.offset ? this.maxWidth / s : f / (s - 1)),
      d + 6 > r &&
        ...
        (l =
          ...
          $t(t.grid) -
          e.padding -
          ks(t.title, this.chart.options.font)),
        (c = Math.sqrt(d * d + u * u)),
        (a = yi(
          Math.min(
            Math.asin(U((h.highest.height + 6) / r, -1, 1)),
            Math.asin(U(l / c, -1, 1)) - Math.asin(U(u / c, -1, 1))
          )
        )),
  ...
  fit() {
    ...
    if (a) {
      ...
      if (
        (r
          ? ((t.width = this.maxWidth), (t.height = $t(o) + l))
          : ((t.height = this.maxHeight), (t.width = $t(o) + l)),
  ...
  _computeLabelSizes(t, e) {
    ...
    for (c = 0; c < e; ++c) {
      if (
        ...
        (b = Ae(s, p.data, p.gc, b, u)), (_ = m);
      else if (z(u))
        for (h = 0, d = u.length; h < d; ++h)
          (y = u[h]),
            !R(y) && !z(y) && ((b = Ae(s, p.data, p.gc, b, y)), (_ += m));
      o.push(b), a.push(_), (r = Math.max(b, r)), (l = Math.max(_, l));
    }
    yr(n, e);
    const v = o.indexOf(r),
      x = a.indexOf(l),
      k = (M) => ({ width: o[M] || 0, height: a[M] || 0 });
    return {
      first: k(0),
      last: k(e - 1),
      widest: k(v),
  ...
  getPixelForDecimal(t) {
    ...
    return po(this._alignToPixels ? Mt(this.chart, e, 0) : e);
  }
  ...
  getContext(t) {
    ...
    if (t >= 0 && t < e.length) {
      const s = e[t];
      return s.$context || (s.$context = Mr(this.getContext(), t, s));
    }
    ...
    if (a === "top")
      ...
      if (a === "center") b = m((t.top + t.bottom) / 2 + 0.5);
        ...
        const P = Object.keys(a)[0],
          H = a[P];
        b = m(this.chart.scales[P].getPixelForValue(H));
      }
      (L = t.top), (D = t.bottom), (k = b + p), (S = k + d);
    } else if (e === "y") {
      ...
      (x = b - p), (M = x - d), (w = t.left), (T = t.right);
    }
    const V = C(n.ticks.maxTicksLimit, h),
      K = Math.max(1, Math.ceil(h / V));
    for (_ = 0; _ < h; _ += K) {
      const P = o.setContext(this.getContext(_)),
        H = P.lineWidth,
        N = P.color,
        vt = P.borderDash || [],
        Ye = P.borderDashOffset,
        Tt = P.tickWidth,
        he = P.tickColor,
        Rt = P.tickBorderDash || [],
        Ht = P.tickBorderDashOffset;
      (y = xr(this, _, r)),
        y !== void 0 &&
          ((v = Mt(s, y, H)),
          l ? (x = M = w = T = v) : (k = S = L = D = v),
          u.push({
            tx1: x,
            ty1: k,
            tx2: M,
  ...
  _computeLabelItems(t) {
    ...
    if (n === "top")
      ...
      if (n === "center") k = (t.top + t.bottom) / 2 + f;
        ...
        const P = Object.keys(n)[0],
          H = n[P];
        k = this.chart.scales[P].getPixelForValue(H) + f;
      }
      ...
      if (n === "center") x = (t.left + t.right) / 2 - f;
        ...
        const P = Object.keys(n)[0],
          H = n[P];
        x = this.chart.scales[P].getPixelForValue(H);
      }
      M = this._getYAxisLabelAlignment(u).textAlign;
    }
    e === "y" && (l === "start" ? (V = "top") : l === "end" && (V = "bottom"));
    ...
    for (b = 0, _ = r.length; b < _; ++b) {
      ...
      const H = T / 2,
        N = P.color,
        vt = P.textStrokeColor,
        Ye = P.textStrokeWidth;
      let Tt = M;
      a
        ? ((x = S),
          M === "inner" &&
          ...
          n === "top"
            ? c === "near" || p !== 0
              ? (D = -T * L + L / 2)
              : c === "center"
              ? (D = -K.highest.height / 2 - H * L + L)
              : (D = -K.highest.height + L / 2)
            : c === "near" || p !== 0
            ? (D = L / 2)
            : c === "center"
            ? (D = K.highest.height / 2 - H * L)
            : (D = K.highest.height - T * L),
          d && (D *= -1))
        : ((k = S), (D = ((1 - T) * L) / 2));
      let he;
      if (P.showLabelBackdrop) {
        const Rt = X(P.backdropPadding),
          Ht = K.heights[b],
          $e = K.widths[b];
        let Ue = k + D - Rt.top,
          Xe = x - Rt.left;
...
class _e {
  ...
  unregister(t) {
    const e = this.items,
      ...
      n = this.scope;
    s in e && delete e[s],
      n && s in O[n] && (delete O[n][s], this.override && delete Ot[s]);
  }
}
function Sr(i, t, e) {
  const s = ie(Object.create(null), [e ? O.get(e) : {}, O.get(t), i.defaults]);
  O.set(t, s),
...
class Dr {
  constructor() {
    (this.controllers = new _e(st, "datasets", !0)),
      (this.elements = new _e(nt, "elements")),
      (this.plugins = new _e(Object, "plugins")),
      (this.scales = new _e(Lt, "scales")),
...
class Ii extends st {
  ...
  updateElements(t, e, s, n) {
    const o = n === "reset",
      ...
      b = zt(p) ? p : Number.POSITIVE_INFINITY,
    ...
    for (let v = e; v < e + s; ++v) {
      const x = t[v],
        ...
        M = _ ? x : {},
        S = R(k[g]),
        w = (M[f] = a.getPixelForValue(k[f], v)),
        L = (M[g] =
          o || S
            ? r.getBasePixel()
            : r.getPixelForValue(l ? this.applyStack(r, k, l) : k[g], v));
      (M.skip = isNaN(w) || isNaN(L) || S),
        (M.stop = v > 0 && Math.abs(k[f] - y[f]) > b),
        m && ((M.parsed = k), (M.raw = c.data[v])),
        u &&
          (M.options =
            d || this.resolveDataElementOptions(v, x.active ? "active" : n)),
...
di.override = function (i) {
  Object.assign(di.prototype, i);
};
var Or = { _date: di };
function Ar(i, t, e, s) {
  ...
  if (r && t === r.axis && t !== "r" && a && o.length) {
    const l = r._reversePixels ? mo : Pt;
    if (s) {
      if (n._sharedOptions) {
        const c = o[0],
  ...
  modes: {
    index(i, t, e, s) {
      const n = wt(t, i),
        ...
        r = e.intersect ? ii(i, n, o, s, a) : si(i, n, o, !1, s, a),
        l = [];
      return r.length
...
const An = ["left", "top", "right", "bottom"];
function Ut(i, t) {
...
function Wr(i, t, e, s) {
  ...
  const r = Math.max(0, t.outerWidth - Ps(a, i, "left", "right")),
    l = Math.max(0, t.outerHeight - Ps(a, i, "top", "bottom")),
    c = r !== i.w,
    h = l !== i.h;
  return (
    (i.w = r),
...
function Gt(i, t, e, s) {
  ...
  for (o = 0, a = i.length, c = 0; o < a; ++o) {
    (r = i[o]),
      (l = r.box),
      l.update(r.width || t.w, r.height || t.h, Vr(r.horizontal, t));
    const { same: d, other: u } = Wr(t, e, r, s);
...
function Cs(i, t, e, s) {
  ...
  for (const r of i) {
    ...
    if (r.horizontal) {
      const d = t.w * h,
        u = c.size || l.height;
      tt(c.start) && (a = c.start),
        l.fullSize
          ? xe(l, n.left, a, e.outerWidth - n.right - n.left, u)
          : xe(l, t.left + c.placed, a, d, u),
        (c.start = a),
        (c.placed += d),
        (a = l.bottom);
    } else {
      const d = t.h * h,
        u = c.size || l.width;
      tt(c.start) && (o = c.start),
        l.fullSize
          ? xe(l, o, n.top, u, e.outerHeight - n.bottom - n.top)
          : xe(l, o, t.top + c.placed, u, d),
        (c.start = o),
        (c.placed += d),
        (o = l.right);
    }
...
var Q = {
  ...
  update(i, t, e, s) {
    if (!i) return;
    const n = X(i.options.layout.padding),
    ...
    Gt(r.fullSize, f, d, g),
      Gt(l, f, d, g),
      Gt(c, f, d, g) && Gt(l, f, d, g),
      Nr(f),
      Cs(r.leftAndTop, f, d, g),
      (f.x += f.w),
      (f.y += f.h),
      Cs(r.rightAndBottom, f, d, g),
      (i.chartArea = {
        left: f.left,
        top: f.top,
        right: f.left + f.w,
...
const Rn = ka ? { passive: !0 } : !1;
function $r(i, t, e) {
  i.addEventListener(t, e, Rn);
}
function Ur(i, t, e) {
  i.canvas.removeEventListener(t, e, Rn);
}
function Xr(i, t) {
  const e = jr[i.type] || i.type,
    { x: s, y: n } = wt(i, t);
  return {
    type: e,
    chart: t,
...
function Kr(i, t, e) {
  const s = i.canvas,
    n = new MutationObserver((o) => {
      let a = !1;
      for (const r of o)
        (a = a || Te(r.addedNodes, s)), (a = a && !Te(r.removedNodes, s));
      a && e();
    });
...
function qr(i, t, e) {
  const s = i.canvas,
    n = new MutationObserver((o) => {
      let a = !1;
      for (const r of o)
        (a = a || Te(r.removedNodes, s)), (a = a && !Te(r.addedNodes, s));
      a && e();
    });
  return n.observe(document, { childList: !0, subtree: !0 }), n;
}
...
function Gr(i, t) {
  ae.size || window.addEventListener("resize", En), ae.set(i, t);
}
function Zr(i) {
  ae.delete(i), ae.size || window.removeEventListener("resize", En);
}
function Jr(i, t, e) {
  const s = i.canvas,
    n = s && Ti(s);
...
class tl extends Tn {
  acquireContext(t, e) {
    ...
    return s && s.canvas === t ? (Yr(t, e), s) : null;
  }
  releaseContext(t) {
    const e = t.canvas;
    if (!e[Se]) return !1;
  ...
  addEventListener(t, e, s) {
    ...
    const n = t.$proxies || (t.$proxies = {}),
      a = { attach: Kr, detach: qr, resize: Jr }[e] || Qr;
    n[e] = a(t, e, s);
  }
  removeEventListener(t, e) {
    const s = t.$proxies || (t.$proxies = {}),
      n = s[e];
    if (!n) return;
    (({ attach: ni, detach: ni, resize: ni }[e] || Ur)(t, e, n),
      (s[e] = void 0));
  }
  getDevicePixelRatio() {
  ...
  _notify(t, e, s, n) {
    ...
    for (const o of t) {
      const a = o.plugin,
        r = a[s],
        l = [e, n, o.options];
      if (I(r, l, a) === !1 && n.cancelable) return !1;
    }
    return !0;
  }
  invalidate() {
...
function ol(i, { plugins: t, localIds: e }, s, n) {
  ...
  for (const r of t) {
    ...
    c !== null &&
      o.push({
        plugin: r,
        options: al(i.config, { plugin: r, local: e[l] }, c, a),
      });
  }
  return o;
}
function al(i, { plugin: t, local: e }, s, n) {
...
function fi(i, t) {
  return i === "x" || i === "y"
    ? i
    : t.axis || cl(t.position) || i.charAt(0).toLowerCase();
}
function hl(i, t) {
  const e = Ot[i.type] || { scales: {} },
    s = t.scales || {},
    n = ui(i.type, t),
  ...
  return (
    Object.keys(s).forEach((r) => {
      ...
      const c = fi(r, l),
        ...
        d = e.scales || {};
      (o[c] = o[c] || r),
        (a[r] = Zt(Object.create(null), [{ axis: c }, l, d[c], d[h]]));
    }),
    i.data.datasets.forEach((r) => {
      const l = r.type || i.type,
...
function Fn(i) {
  ...
  (t.plugins = C(t.plugins, {})), (t.scales = hl(i, t));
}
function In(i) {
  return (
    (i = i || {}),
...
function dl(i) {
  return (i = i || {}), (i.data = In(i.data)), Fn(i), i;
}
const As = new Map(),
  zn = new Set();
function ye(i, t) {
  let e = As.get(i);
  return e || ((e = t()), As.set(i, e), zn.add(e)), e;
}
const Kt = (i, t, e) => {
  const s = _t(t, e);
  s !== void 0 && i.add(s);
...
class ul {
  ...
  getOptionScopes(t, e, s) {
    ...
    const l = new Set();
    e.forEach((h) => {
      t && (l.add(t), h.forEach((d) => Kt(l, t, d))),
        h.forEach((d) => Kt(l, n, d)),
        h.forEach((d) => Kt(l, Ot[o] || {}, d)),
        h.forEach((d) => Kt(l, O, d)),
        h.forEach((d) => Kt(l, ci, d));
    });
    const c = Array.from(l);
    return (
      c.length === 0 && c.push(Object.create(null)), zn.has(e) && a.set(e, c), c
    );
  }
  chartOptionScopes() {
    const { options: t, type: e } = this;
    return [t, Ot[e] || {}, O.datasets[e] || {}, { type: e }, O, ci];
  }
  resolveNamedOptions(t, e, s, n = [""]) {
    const o = { $shared: !0 },
      { resolver: a, subPrefixes: r } = Ls(this._resolverCache, t, n);
    let l = a;
    if (gl(a, e)) {
...
const fl = (i) =>
  A(i) && Object.getOwnPropertyNames(i).reduce((t, e) => t || xt(i[e]), !1);
function gl(i, t) {
  const { isScriptable: e, isIndexable: s } = pn(i);
  for (const n of t) {
    const o = e(n),
      a = s(n),
      r = (a || o) && i[n];
    if ((o && (xt(r) || fl(r))) || (a && z(r))) return !0;
  }
  return !1;
}
var pl = "3.9.1";
const ml = ["top", "bottom", "left", "right", "chartArea"];
function Ts(i, t) {
...
class Ee {
  constructor(t, e) {
    ...
    (this.platform = new (s.platform || el(n))()),
    ...
    if (
      ...
      (this.scales = {}),
      (this._plugins = new il()),
      (this.$proxies = {}),
      (this._hiddenIndices = {}),
      (this.attached = !1),
      (this._animationsDisabled = void 0),
      (this.$context = void 0),
      (this._doResize = xo((d) => this.update(d), a.resizeDelay || 0)),
      (this._dataChanges = []),
      (Re[this.id] = this),
      !r || !l)
    ) {
    ...
    ct.listen(this, "complete", Es),
      ct.listen(this, "progress", bl),
      this._initialize(),
  ...
  clear() {
    return is(this.canvas, this.ctx), this;
  }
  stop() {
    ...
    e &&
      ...
      E(o, (a) => {
        const r = a.options,
          ...
          c = fi(l, r),
          h = C(r.type, a.dtype);
        (r.position === void 0 || Ts(r.position, c) !== Ts(a.dposition)) &&
  ...
  buildOrUpdateControllers() {
    ...
    for (this._removeUnreferencedMetasets(), s = 0, n = e.length; s < n; s++) {
      ...
      if (
        ...
        (a.type = r),
        (a.indexAxis = o.indexAxis || ui(r, this.options)),
        (a.order = o.order || 0),
        (a.index = s),
        (a.label = "" + o.label),
  ...
  _checkEventBindings() {
    const t = this.options,
      ...
      s = new Set(t.events);
    (!Yi(e, s) || !!this._responsiveListeners !== t.responsive) &&
  ...
  _getUniformDataChanges() {
    ...
    const e = this.data.datasets.length,
      ...
      n = s(0);
    for (let o = 1; o < e; o++) if (!Yi(n, s(o))) return;
    return Array.from(n)
      .map((o) => o.split(","))
  ...
  _updateDatasets(t) {
    if (
      ...
      for (let e = 0, s = this.data.datasets.length; e < s; ++e)
        this._updateDataset(e, xt(t) ? t({ datasetIndex: e }) : t);
  ...
  _stop() {
    let t, e;
    for (
      this.stop(), ct.remove(this), t = 0, e = this.data.datasets.length;
      t < e;
      ++t
    )
  ...
  _handleEvent(t, e, s) {
    ...
    s &&
      ((this._lastEvent = null),
      I(o.onHover, [t, r, this], this),
      l && I(o.onClick, [t, r, this], this));
    const h = !Pe(r, n);
    return (
...
const Fs = () => E(Ee.instances, (i) => i._plugins.invalidate()),
  ft = !0;
Object.defineProperties(Ee, {
  defaults: { enumerable: ft, value: O },
  instances: { enumerable: ft, value: Re },
  overrides: { enumerable: ft, value: Ot },
  registry: { enumerable: ft, value: at },
  version: { enumerable: ft, value: pl },
  getChart: { enumerable: ft, value: Wn },
  register: {
    enumerable: ft,
    value: (...i) => {
      at.add(...i), Fs();
...
function vl(i, t, e, s) {
  const n = yl(i.options.borderRadius),
    o = (e - t) / 2,
    a = Math.min(o, (s * t) / 2),
    r = (l) => {
  ...
  return {
    ...
    innerStart: U(n.innerStart, 0, a),
    innerEnd: U(n.innerEnd, 0, a),
  };
}
function Ft(i, t, e, s) {
...
function gi(i, t, e, s, n, o) {
  ...
  const p = Math.max(0.001, g * d - e / B) / d,
    m = (g - p) / 2,
    b = l + m + f,
    _ = n - m - f,
    {
    ...
    K = _ - k / D;
  if ((i.beginPath(), o)) {
    if ((i.arc(a, r, d, w, L), v > 0)) {
      const N = Ft(S, L, a, r);
      i.arc(N.x, N.y, v, L, _ + W);
    }
    const P = Ft(D, _, a, r);
    if ((i.lineTo(P.x, P.y), k > 0)) {
      const N = Ft(D, K, a, r);
      i.arc(N.x, N.y, k, _ + W, K + Math.PI);
    }
    if ((i.arc(a, r, u, _ - k / u, b + x / u, !0), x > 0)) {
      const N = Ft(T, V, a, r);
      i.arc(N.x, N.y, x, V + Math.PI, b - W);
    }
    const H = Ft(M, b, a, r);
    if ((i.lineTo(H.x, H.y), y > 0)) {
      const N = Ft(M, w, a, r);
      i.arc(N.x, N.y, y, b - W, w);
    }
  } else {
    i.moveTo(a, r);
    const P = Math.cos(w) * d + a,
      H = Math.sin(w) * d + r;
    i.lineTo(P, H);
    const N = Math.cos(L) * d + a,
      vt = Math.sin(L) * d + r;
    i.lineTo(N, vt);
  }
  i.closePath();
...
function kl(i, t, e) {
  const { x: s, y: n, startAngle: o, pixelMargin: a, fullCircles: r } = t,
    l = Math.max(t.outerRadius - a, 0),
    c = t.innerRadius + a;
  let h;
  for (
    e && Nn(i, t, o + F), i.beginPath(), i.arc(s, n, c, o + F, o, !0), h = 0;
    h < r;
    ++h
  )
    i.stroke();
...
class zi extends nt {
  ...
  inRange(t, e, s) {
    const n = this.getProps(["x", "y"], s),
      { angle: o, distance: a } = tn(n, { x: t, y: e }),
      {
        startAngle: r,
        endAngle: l,
        innerRadius: c,
  ...
  draw(t) {
    ...
    const l = Ml(t, this, r, o, a);
    wl(t, this, r, o, l, a), t.restore();
  }
}
zi.id = "arc";
zi.defaults = {
...
zi.defaultRoutes = { backgroundColor: "backgroundColor" };
function Vn(i, t, e = t) {
...
function Cl(i, t, e, s) {
  const { points: n, options: o } = t,
    { count: a, start: r, loop: l, ilen: c } = Hn(n, e, s),
    h = Pl(o);
...
function Dl(i, t, e, s) {
  const n = t.points,
    { count: o, start: a, ilen: r } = Hn(n, e, s),
  ...
  for (l && ((f = n[_(0)]), i.moveTo(f.x, f.y)), u = 0; u <= r; ++u) {
    ...
    const v = f.x,
      ...
      k = v | 0;
    k === g
      ? (x < p ? (p = x) : x > m && (m = x), (h = (d * h + v) / ++d))
      : (y(), i.lineTo(v, x), (g = k), (d = 0), (p = m = x)),
      (b = x);
  }
  y();
}
...
function Rl(i, t, e, s) {
  Tl && !t.options.segment ? Al(i, t, e, s) : Ll(i, t, e, s);
}
class Ne extends nt {
  constructor(t) {
    super(),
  ...
  updateControlPoints(t, e) {
    ...
    if (
      ...
      ma(this._points, s, t, n, e), (this._pointsUpdated = !0);
    }
  }
  set points(t) {
    (this._points = t),
  ...
  get segments() {
    return this._segments || (this._segments = Ea(this, this.options.segment));
  }
  first() {
  ...
  interpolate(t, e) {
    const s = this.options,
      n = t[e],
      o = this.points,
      a = La(this, { property: e, start: n, end: n });
    if (!a.length) return;
    const r = [],
      l = Ol(s);
    let c, h;
  ...
  draw(t, e, s, n) {
    ...
    (this.points || []).length &&
      o.borderWidth &&
      (t.save(), Rl(t, this, s, n), t.restore()),
...
function oi(i, t, e, s) {
  const n = t === null,
    o = e === null,
    r = i && !(n && o) && jn(i, s);
  return r && (n || gt(t, r.left, r.right)) && (o || gt(e, r.top, r.bottom));
}
function zl(i) {
...
class Bs extends nt {
  ...
  fit() {
    ...
    const s = t.labels,
      ...
      { boxWidth: r, itemHeight: l } = zs(s, o);
    let c, h;
    (e.font = n.string),
      this.isHorizontal()
  ...
  _fitCols(t, e, s, n) {
    ...
    return (
      this.legendItems.forEach((m, b) => {
        const _ = s + e / 2 + o.measureText(m.text).width;
        b > 0 &&
          f + n + 2 * r > h &&
          ((d += u + r),
  ...
  adjustHitBoxes() {
    ...
    const t = this._computeTitleHeight(),
      ...
      a = It(o, this.left, this.width);
    if (this.isHorizontal()) {
      let r = 0,
        l = $(s, this.left + n, this.right - this.lineWidths[r]);
      for (const c of e)
        r !== c.row &&
          ((r = c.row),
          (l = $(s, this.left + n, this.right - this.lineWidths[r]))),
      ...
      let r = 0,
        l = $(s, this.top + t + n, this.bottom - this.columnSizes[r].height);
      for (const c of e)
        c.col !== r &&
          ((r = c.col),
          (l = $(
  ...
  _draw() {
    ...
    this.drawTitle(),
      ...
      (n.lineWidth = 0.5),
      (n.font = c.string);
    const { boxWidth: p, boxHeight: m, itemHeight: b } = zs(a, u),
      _ = function (M, S, w) {
        if (isNaN(p) || p <= 0 || isNaN(m) || m < 0) return;
        n.save();
        const L = C(w.lineWidth, 1);
        if (
          ((n.fillStyle = C(w.fillStyle, r)),
          (n.lineCap = C(w.lineCap, "butt")),
          (n.lineDashOffset = C(w.lineDashOffset, 0)),
          (n.lineJoin = C(w.lineJoin, "miter")),
          (n.lineWidth = L),
          (n.strokeStyle = C(w.strokeStyle, r)),
          n.setLineDash(C(w.lineDash, [])),
          a.usePointStyle)
        ) {
          const T = {
            ...
            D = l.xPlus(M, p / 2),
            V = S + f;
          fn(n, T, D, V, a.pointStyleWidth && p);
        } else {
          const T = S + Math.max((u - m) / 2, 0),
            D = l.leftForLtr(M, p),
            V = Ct(w.borderRadius);
          n.beginPath(),
            Object.values(V).some((K) => K !== 0)
              ? oe(n, { x: D, y: T, w: p, h: m, radius: V })
              : n.rect(D, T, p, m),
            n.fill(),
            L !== 0 && n.stroke();
        }
    ...
    v
      ? (g = {
          x: $(o, this.left + d, this.right - s[0]),
          y: this.top + d + x,
          line: 0,
        })
      : (g = {
          x: this.left + d,
          y: $(o, this.top + x + d, this.bottom - e[0].height),
          line: 0,
        }),
    ...
    this.legendItems.forEach((M, S) => {
      ...
      const w = n.measureText(M.text).width,
        L = l.textAlign(M.textAlign || (M.textAlign = a.textAlign)),
        T = p + f + w;
      let D = g.x,
        V = g.y;
      l.setWidth(this.width),
        v
          ? S > 0 &&
            ...
            ((V = g.y += k),
            g.line++,
            (D = g.x = $(o, this.left + d, this.right - s[g.line])))
          : S > 0 &&
            V + k > this.bottom &&
            ((D = g.x = D + e[g.line].width + d),
            g.line++,
            (V = g.y = $(o, this.top + x + d, this.bottom - e[g.line].height)));
      const K = l.x(D);
      _(K, V, M),
        (D = yo(L, D + p + f, v ? D + T : this.right, t.rtl)),
        y(l.x(D), V, M),
        v ? (g.x += T + d) : (g.y += k);
    }),
  ...
  _getLegendItemAt(t, e) {
    ...
    if (gt(t, this.left, this.right) && gt(e, this.top, this.bottom)) {
      for (o = this.legendHitBoxes, s = 0; s < o.length; ++s)
        if (
          ((n = o[s]),
          gt(t, n.left, n.left + n.width) && gt(e, n.top, n.top + n.height))
        )
  ...
  _drawArgs(t) {
    ...
    return (
      this.isHorizontal()
        ? ((h = $(r, s, o)), (d = e + t), (c = o - s))
        : (a.position === "left"
            ? ((h = s + t), (d = $(r, n, e)), (l = B * -0.5))
            : ((h = o - t), (d = $(r, e, n)), (l = B * 0.5)),
          (c = n - e)),
...
function Vl(i, t) {
  const e = new Yn({ ctx: i.ctx, options: t, chart: i });
...
function Ws(i, t) {
  ...
  return (
    ...
    E(i.title, y),
    (e.font = l.string),
    E(i.beforeBody.concat(i.afterBody), y),
...
function Vs(i, t, e, s) {
  const { caretSize: n, caretPadding: o, cornerRadius: a } = i,
    { xAlign: r, yAlign: l } = e,
    c = n + o,
    { topLeft: h, topRight: d, bottomLeft: u, bottomRight: f } = Ct(a);
  let g = Ul(t, r);
  const p = Xl(t, l, c);
  return (
    l === "center"
    ...
    { x: U(g, 0, s.width - t.width), y: U(p, 0, s.height - t.height) }
  );
}
function ve(i, t, e) {
  const s = X(e.padding);
...
class mi extends nt {
  ...
  _resolveAnimations() {
    ...
    const e = this.chart,
      ...
      o = new Sn(this.chart, n);
    return n._cacheable && (this._cachedAnimations = Object.freeze(o)), o;
  }
  getContext() {
    return (
      this.$context ||
      (this.$context = Kl(this.chart.getContext(), this, this._tooltipItems))
    );
  }
  getTitle(t, e) {
    const { callbacks: s } = e,
    ...
    let r = [];
    return (r = ot(r, ht(n))), (r = ot(r, ht(o))), (r = ot(r, ht(a))), r;
  }
  getBeforeBody(t, e) {
    return Hs(e.callbacks.beforeBody.apply(this, [t]));
  }
  getBody(t, e) {
    const { callbacks: s } = e,
      n = [];
    return (
      E(t, (o) => {
        const a = { before: [], lines: [], after: [] },
          r = js(s, o);
        ot(a.before, ht(r.beforeLabel.call(this, o))),
          ot(a.lines, r.label.call(this, o)),
          ot(a.after, ht(r.afterLabel.call(this, o))),
          n.push(a);
      }),
      n
    );
  ...
  getAfterBody(t, e) {
    return Hs(e.callbacks.afterBody.apply(this, [t]));
  }
  getFooter(t, e) {
    const { callbacks: s } = e,
  ...
  _createItems(t) {
    ...
    let r = [],
      l,
      c;
    for (l = 0, c = e.length; l < c; ++l) r.push(Hl(this.chart, e[l]));
    return (
  ...
  update(t, e) {
    ...
    if (!n.length) this.opacity !== 0 && (o = { opacity: 0 });
      ...
      const l = (this._size = Ws(this, s)),
        c = Object.assign({}, r, l),
        h = Ns(this.chart, s, c),
        d = Vs(s, c, h, this.chart);
  ...
  getCaretPosition(t, e, s) {
    const { xAlign: n, yAlign: o } = this,
      ...
      { topLeft: l, topRight: c, bottomLeft: h, bottomRight: d } = Ct(r),
      { x: u, y: f } = t,
      { width: g, height: p } = e;
    let m, b, _, y, v, x;
    return (
  ...
  _drawColorBox(t, e, s, n, o) {
    ...
    if (o.usePointStyle) {
      ...
      Object.values(_).some((y) => y !== 0)
        ? (t.beginPath(),
          (t.fillStyle = o.multiKeyBackground),
          oe(t, { x: m, y: p, w: c, h: l, radius: _ }),
          t.fill(),
          t.stroke(),
          (t.fillStyle = a.backgroundColor),
          t.beginPath(),
          oe(t, { x: b, y: p + 1, w: c - 2, h: l - 2, radius: _ }),
          t.fill())
        : ((t.fillStyle = o.multiKeyBackground),
          t.fillRect(m, p, c, l),
...
var Cc = {
  ...
  positioners: ee,
  afterInit(i, t, e) {
    e && (i.tooltip = new mi({ chart: i, options: e }));
  },
  beforeUpdate(i, t, e) {
...
function Gl(i, t, e, s) {
  const n = i.indexOf(t);
  if (n === -1) return ql(i, t, e, s);
  const o = i.lastIndexOf(t);
  return n !== o ? e : n;
}
const Zl = (i, t) => (i === null ? null : U(Math.round(i), 0, t));
class bi extends Lt {
  constructor(t) {
    super(t),
  ...
  parse(t, e) {
    ...
    return (
      (e =
        isFinite(e) && s[e] === t ? e : Gl(s, t, C(e, t), this._addedLabels)),
      Zl(e, s.length - 1)
    );
  }
  determineDataLimits() {
...
bi.id = "category";
bi.defaults = { ticks: { callback: bi.prototype.getLabelForValue } };
function Jl(i, t) {
  const e = [],
    {
      bounds: n,
  ...
  (w = Math.ceil(m / x) - Math.floor(p / x)),
    w > g && (x = Ui((w * x) / g / f) * f),
    R(l) || ((k = Math.pow(10, l)), (x = Math.ceil(x * k) / k)),
    n === "ticks"
      ? ((M = Math.floor(p / x) * x), (S = Math.ceil(m / x) * x))
      : ((M = p), (S = m)),
    b && _ && o && fo((r - a) / o, x / 1e3)
      ? ((w = Math.round(Math.min((r - a) / x, h))),
        (x = (r - a) / w),
        (M = a),
        (S = r))
      : y
      ? ((M = b ? a : M), (S = _ ? r : S), (w = c - 1), (x = (S - M) / w))
      : ((w = (S - M) / x),
        Jt(w, Math.round(w), x / 1e3)
          ? (w = Math.round(w))
          : (w = Math.ceil(w)));
  const L = Math.max(Xi(x), Xi(M));
  (k = Math.pow(10, R(l) ? L : l)),
    (M = Math.round(M * k) / k),
    (S = Math.round(S * k) / k);
  let T = 0;
  for (
    ...
    (u && M !== a
      ? (e.push({ value: a }),
        M < a && T++,
        Jt(Math.round((M + T * x) * k) / k, a, Ys(a, v, i)) && T++)
      : M < a && T++);
    T < w;
    ++T
  )
    e.push({ value: Math.round((M + T * x) * k) / k });
  return (
    _ && u && S !== r
      ? e.length && Jt(e[e.length - 1].value, r, Ys(r, v, i))
...
class Fe extends Lt {
  ...
  buildTicks() {
    ...
    const n = {
      ...
      a = Jl(n, o);
    return (
      t.bounds === "ticks" && Qs(a, this, "value"),
      t.reverse
...
$n.id = "linear";
$n.defaults = { ticks: { callback: We.formatters.numeric } };
function $s(i) {
  return i / Math.pow(10, Math.floor(J(i))) === 1;
}
function Ql(i, t) {
  const e = Math.floor(J(t.max)),
    s = Math.ceil(t.max / Math.pow(10, e)),
    n = [];
  let o = Z(i.min, Math.pow(10, Math.floor(J(t.min)))),
    a = Math.floor(J(o)),
    r = Math.floor(o / Math.pow(10, a)),
    l = a < 0 ? Math.pow(10, Math.abs(a)) : 1;
  do
    n.push({ value: o, major: $s(o) }),
      ++r,
      r === 10 && ((r = 1), ++a, (l = a >= 0 ? 1 : l)),
      (o = Math.round(r * Math.pow(10, a) * l) / l);
  while (a < e || (a === e && r < s));
  const c = Z(i.max, o);
  return n.push({ value: c, major: $s(o) }), n;
}
class Un extends Lt {
  constructor(t) {
    super(t),
  ...
  handleTickRangeOptions() {
    ...
    const o = (l) => (s = t ? s : l),
      a = (l) => (n = e ? n : l),
      r = (l, c) => Math.pow(10, Math.floor(J(l)) + c);
  ...
  buildTicks() {
    const t = this.options,
      ...
      s = Ql(e, this);
    return (
      t.bounds === "ticks" && Qs(s, this, "value"),
      t.reverse
  ...
  configure() {
    const t = this.min;
    super.configure(),
      (this._startValue = J(t)),
      (this._valueRange = J(this.max) - J(t));
  }
  getPixelForValue(t) {
    return (
      ...
      t === null || isNaN(t)
        ...
        : this.getPixelForDecimal(
            t === this.min ? 0 : (J(t) - this._startValue) / this._valueRange
          )
    );
  }
  getValueForPixel(t) {
...
function tc(i, t, e) {
  return (
    (e = z(e) ? e : [e]), { w: $o(i, t.string, e), h: e.length * t.lineHeight }
  );
}
...
function ec(i) {
  ...
  for (let l = 0; l < o; l++) {
    ...
    s[l] = u;
    const f = et(i.getIndexAngle(l) + r),
      g = Math.round(yi(f)),
      p = Us(g, h.x, u.w, 0, 180),
      m = Us(g, h.y, u.h, 90, 270);
    ic(e, t, f, p, m);
  }
  i.setCenterPoint(t.l - e.l, e.r - t.r, t.t - e.t, e.b - t.b),
    (i._pointLabelItems = sc(i, s, n));
}
...
function rc(i, t) {
  ...
  for (let n = t - 1; n >= 0; n--) {
    const o = s.setContext(i.getPointLabelContext(n)),
      ...
      { backdropColor: g } = o;
    if (!R(g)) {
      const p = Ct(o.borderRadius),
        m = X(o.backdropPadding);
      e.fillStyle = g;
      const b = h - m.left,
        _ = d - m.top,
        y = u - h + m.width,
      ...
      Object.values(p).some((x) => x !== 0)
        ? (e.beginPath(),
          oe(e, { x: b, y: _, w: y, h: v, radius: p }),
          e.fill())
        : e.fillRect(b, _, y, v);
    }
    At(e, i._pointLabels[n], r, l + a.lineHeight / 2, a, {
      color: o.color,
      textAlign: c,
      textBaseline: "middle",
    });
...
class Ve extends Fe {
  ...
  setDimensions() {
    const t = (this._padding = X(_i(this.options) / 2)),
  ...
  generateTickLabels(t) {
    Fe.prototype.generateTickLabels.call(this, t),
  ...
  drawGrid() {
    ...
    let a, r, l;
    if (
      (e.pointLabels.display && rc(this, o),
      n.display &&
      ...
      for (t.save(), a = o - 1; a >= 0; a--) {
        const c = s.setContext(this.getPointLabelContext(a)),
  ...
  drawLabels() {
    ...
    t.save(),
      ...
      this.ticks.forEach((r, l) => {
        ...
        At(t, r.label, 0, -o, h, { color: c.color });
      }),
      t.restore();
  }
  drawTitle() {}
...
Ve.descriptors = { angleLines: { _fallback: "grid" } };
const He = {
...
function Xs(i, t) {
  ...
  return (
    ...
    Y(a) || (a = typeof s == "string" ? e.parse(a, s) : e.parse(a)),
    a === null
      ? null
      : (n &&
          (a =
...
function dc(i, t, e, s, n) {
  for (let o = q.length - 1; o >= q.indexOf(e); o--) {
    const a = q[o];
    if (He[a].common && i._adapter.diff(n, s, a) >= t - 1) return a;
  }
  return q[e ? q.indexOf(e) : 0];
}
function uc(i) {
  for (let t = q.indexOf(i) + 1, e = q.length; t < e; ++t)
    if (He[q[t]].common) return q[t];
}
function qs(i, t, e) {
  if (!e) i[t] = !0;
  else if (e.length) {
    const { lo: s, hi: n } = vi(e, t),
      o = e[s] >= t ? e[s] : e[n];
    i[o] = !0;
  }
}
...
class je extends Lt {
  ...
  determineDataLimits() {
    ...
    (!a || !r) &&
      ...
      (t.bounds !== "ticks" || t.ticks.source !== "labels") &&
        l(this.getMinMax(!1))),
      (n = Y(n) && !isNaN(n) ? n : +e.startOf(Date.now(), s)),
      (o = Y(o) && !isNaN(o) ? o : +e.endOf(Date.now(), s) + 1),
  ...
  buildTicks() {
    ...
    return (
      (this._unit =
        e.unit ||
        (s.autoSkip
          ? Ks(e.minUnit, this.min, this.max, this._getLabelCapacity(o))
          : dc(this, r.length, e.minUnit, this.min, this.max))),
      (this._majorUnit =
        !s.major.enabled || this._unit === "year" ? void 0 : uc(this._unit)),
      this.initOffsets(n),
      t.reverse && r.reverse(),
      Gs(this, r, this._majorUnit)
    );
  }
  afterAutoSkip() {
  ...
  _generate() {
    const t = this._adapter,
      ...
      n = this.options,
      o = n.time,
      a = o.unit || Ks(o.minUnit, e, s, this._getLabelCapacity(e)),
      r = C(o.stepSize, 1),
    ...
    for (u = d, f = 0; u < s; u = +t.add(u, r, a), f++) qs(h, u, g);
    return (
      (u === s || n.bounds === "ticks" || f === 1) && qs(h, u, g),
      Object.keys(h)
        .sort((p, m) => p - m)
        .map((p) => +p)
    );
  ...
  _getLabelCapacity(t) {
    const e = this.options.time,
      ...
      o = this._tickFormatFunction(t, 0, Gs(this, [t], this._majorUnit), n),
...
function Me(i, t, e) {
  let s = 0,
    ...
    l;
  e
    ? (t >= i[s].pos && t <= i[n].pos && ({ lo: s, hi: n } = Pt(i, "pos", t)),
      ({ pos: o, time: r } = i[s]),
      ({ pos: a, time: l } = i[n]))
    : (t >= i[s].time &&
        t <= i[n].time &&
        ({ lo: s, hi: n } = Pt(i, "time", t)),
      ({ time: o, pos: r } = i[s]),
      ({ time: a, pos: l } = i[n]));
  const c = a - o;
...
class Kn extends je {
  ...
  initOffsets() {
    ...
    (this._minPos = Me(e, this.min)),
      (this._tableRange = Me(e, this.max) - this._minPos),
      super.initOffsets(t);
  }
  buildLookupTable(t) {
...
Kn.id = "timeseries";
Kn.defaults = je.defaults;
var Nt;
(function (i) {
  (i.ChartRendered = "chart:rendered"),
    (i.ChartUpdated = "chart:updated"),
    (i.ChartDestroyed = "chart:destroyed"),
    (i.LabelsUpdated = "labels:updated");
})(Nt || (Nt = {}));
function ke(i, t, e, s) {
  i(t, e), s !== void 0 && s.emit(Nt.ChartRendered);
}
function gc(i, t) {
  i.update(), t !== void 0 && t.emit(Nt.ChartUpdated);
}
function we(i, t) {
  i.destroy(), t !== void 0 && t.emit(Nt.ChartDestroyed);
}
function pc(i, t) {
  const e = {
    labels: typeof i.labels == "undefined" ? [] : [...i.labels],
    datasets: [],
  };
  return qn(e, { ...i }, t), e;
}
...
function mc(i, t, e) {
  (i.data.labels = t), e !== void 0 && e.emit(Nt.LabelsUpdated);
}
function bc(i, t) {
  i.options = { ...t };
}
function _c(i, t) {
  const e = i.datasets.map((n) => n.label),
    s = t.datasets.map((n) => n.label);
  return (
    t.datasets.length === i.datasets.length && e.every((n, o) => n === s[o])
  );
}
const xc =
  ...
  yc = "Update ERROR: chart instance not found",
  Ni = (i, t, e) =>
    Zn({
      props: {
      ...
      setup(s, n) {
        ...
        const o = Jn(null),
          a = Qn(null);
        function r(d, u) {
          if ((o.value !== null && we(ut(o.value), n), a.value === null))
            throw new Error(xc);
          {
            const f = pc(d, s.datasetIdKey),
              g = a.value.getContext("2d");
            g !== null &&
              (o.value = new Ee(g, {
                type: t,
                data: Ke(d) ? new Proxy(f, {}) : f,
                options: u,
                plugins: s.plugins,
              }));
          }
        ...
        function l(d, u) {
          ...
          if (Object.keys(g).length > 0) {
            const p = ut(o.value);
            _c(f, g) && p !== null
              ? (qn(p == null ? void 0 : p.data, f, s.datasetIdKey),
                f.labels !== void 0 && mc(p, f.labels, n),
                h())
              : (p !== null && we(p, n), ke(r, s.chartData, s.chartOptions, n));
          } else
            o.value !== null && we(ut(o.value), n),
              ke(r, s.chartData, s.chartOptions, n);
        }
        function c(d) {
          const u = ut(o.value);
          u !== null ? (bc(u, d), h()) : ke(r, s.chartData, s.chartOptions, n);
        }
        function h() {
          const d = ut(o.value);
          d !== null ? gc(d, n) : console.error(yc);
        }
        return (
          Vi(
            () => s.chartData,
          ...
          to(() => {
            "datasets" in s.chartData &&
              s.chartData.datasets.length > 0 &&
              ke(r, s.chartData, s.chartOptions, n);
          }),
          eo(() => {
            o.value !== null && we(ut(o.value), n);
          }),
          n.expose({ chart: o, updateChart: h }),
          () =>
            Hi("div", { style: s.styles, class: s.cssClasses }, [
              Hi("canvas", {
                id: s.chartId,
                width: s.width,
                height: s.height,
  ...
  Dc = Ni("bar-chart", "bar", ze),
  Oc = Ni("doughnut-chart", "doughnut", Vt),
  Ac = Ni("line-chart", "line", Be);
export {
  zi as A,
  Wi as B,
  Ee as C,
