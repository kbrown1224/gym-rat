...
import { Q as Ne } from "./QResizeObserver.73d9f52c.js";
  ...
  function R(r) {
    De(r, [13, 32])
      ...
      : We(r) !== !0 &&
        ...
        r.altKey !== !0 &&
        r.metaKey !== !0 &&
        l.onKbdNavigate(r.keyCode, O.$el) === !0 &&
        ce(r),
      _("keydown", r);
  }
  function $() {
    ...
    t.icon !== void 0 && c.push(h(H, { class: "q-tab__icon", name: t.icon })),
      t.label !== void 0 &&
    ...
    const m = [
      ...
      h("div", { class: L.value }, Fe(x.default, c)),
    ];
...
const Ye = ["left", "center", "right", "justify"];
var nt = Ve({
  name: "QTabs",
  props: {
  ...
  setup(t, { slots: x, emit: _ }) {
    const { proxy: v } = he(),
      ...
      { registerTick: M } = p(),
      { registerTick: W } = p(),
      { registerTimeout: F, removeTimeout: N } = ve(),
    ...
    function ke() {
      ...
      for (const o of n) {
        ...
        const {
          ...
          J = Object.keys(Y).length;
        if (d === !0) {
          if (q !== u || J !== i || le(s, Y) === !1) continue;
          e = o.name.value;
          break;
        }
        if ((q !== "" && q !== u) || (J !== 0 && le(Y, s) === !1)) continue;
        const S = {
    ...
    function z() {
      ie.avoidRouteWatcher === !1 ? I(ke) : U();
    }
    function re() {
      if (b === void 0) {
        const e = D(() => v.$route.fullPath, z);
        b = () => {
          e(), (b = void 0);
        };
      }
    ...
    function Pe(e) {
      c.push(e),
        ...
        e.routeData === void 0 || v.$route === void 0
          ...
          : (re(), e.routeData.hasRouterLink.value === !0 && z());
    }
    function Ie(e) {
      c.splice(c.indexOf(e), 1),
        ...
        b !== void 0 &&
          e.routeData !== void 0 &&
          (c.every((a) => a.routeData === void 0) === !0 && b(), z());
    }
    const ie = {
      currentModel: C,
      tabProps: ge,
    ...
    return (
      ...
      () => {
        const e = [
          h(Ne, { onResize: ee }),
          h("div", { ref: g, class: Ce.value, onScroll: P }, He(x.default)),
        ];
        return (
          r.value === !0 &&
            e.push(
